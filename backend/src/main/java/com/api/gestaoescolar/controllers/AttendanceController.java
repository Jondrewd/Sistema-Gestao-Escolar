...
import org.springframework.web.bind.annotation.DeleteMappingequestParam;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.PutMapping;
...
ioswaggerv3.oas.annotations.Operation
...
public class AttendanceController {
    ...
    public ResponseEntity<AttendanceDTO> findById(
        ...
        AttendanceDTO attendance = service.findById(id);
    if (attendance == null) {
    ...
    public ResponseEntity<AttendanceDTO> update(
            ...
            @PathVariable Long id,
            @Valid @RequestBody AttendanceDTO attendanceDTO) {
        AttendanceDTO updated = service.update(id, attendanceDTO);
        if (updated == null) {
        return ResponseEntity.notFound().build();
        }
